    ...
    navbarPage("🔎 MiMo App",
               ...
               navbarMenu("Let's get started!",
                          ...
                          tabPanel("(1) Enter text",
                                   h1("MiMo Language Analysis App"),
                                   tags$p("For documentation 📄: ", 
                                           tags$a("www.docs.mimolanguageanalysis.uk", 
                                                  href = "https://www.docs.mimolanguageanalysis.uk", 
                                                  target = "_blank")),
                                   tags$p("GitHub ⚙️: ", 
                                           tags$a("github.com/nickriches/MiMoShinyLive", 
                                                  href = "https://github.com/nickriches/MiMoShinyLive", 
                                                  target = "_blank")),
        ...
        verb_form <- function(x){
          return(
            case_when(
              ...
              grepl("Tense=Past[\x7c]VerbForm=Part", x) == TRUE ~ "hasPerfForm hasPastParticiple",
              grepl("Tense=Pres[\x7c]VerbForm=Part", x) == TRUE ~ "hasProgForm hasPresParticiple",
